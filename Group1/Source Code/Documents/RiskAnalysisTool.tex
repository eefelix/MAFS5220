...
\documentclass[prodmode,oneside,mafs5220,final]{acmsmall} % Aptara syntax
...
% Page heads
\markboth{MAFS 5220 Group 1}{Risk Analysis Tool Design and Implementation Document}

% Title portion
\title{Risk Analysis Tool Design and Implementation Document}
\author{
Yan CHEN
\affil{ychence@connect.ust.hk}
Xiang GAO
\affil{xgaoaa@connect.ust.hk}
Tian XIE
\affil{txieaa@connect.ust.hk}
Fang XIONG
\affil{fxiongaa@connect.ust.hk}
}
